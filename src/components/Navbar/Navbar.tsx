...
function NavigationComp() {
	...
	return (
		<header
			className="navbar-header fixed top-0 left-0 w-full z-50 h-fit border-b shadow-md shadow-appGray/10 border-appYellow/10  backdrop-blur-lg "
			>
			<div className="flex justify-between items-center py-3 px-4 md:px-12 " >
				...
				<ButtonComp
					...
					title="let's talk"
					className="hidden md:flex py-2 dark:hover:bg-appYellow/80 dark:hover:border-appYellow hover:bg-appBlue/80 hover:border-appBlue "
				/>
			</div>
		</header>
	);
