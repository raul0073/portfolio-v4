...
function HamburgerMenuBtn({
	...
	return (
		<button
		{...props}
			className={`hamburger-btn md:hidden text-gray-500 size-11 relative outline-none transition-colors duration-300 ease-linear  bg-transparent hover:bg-transparent border dark:border-white/10 border-stone-300 rounded-full hover:text-white ${isOpen && 'border-red-600/30'}`}
			onClick={toggleMenu}>
