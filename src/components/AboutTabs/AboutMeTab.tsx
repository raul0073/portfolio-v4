				...
				<div className="actions flex justify-center gap-4 mt-[10%]">
					{
						SOCIAL_ICONS.map((icon)=> {
							const dataAttribute = { [`data-umami-${icon.name}`]: true };
							return (
								<button key={icon.name} {...dataAttribute} className="group text-white  inline-flex items-center justify-center dark:bg-gradient-to-b dark:from-[#464d55] dark:to-[#25292e] bg-gradient-to-b from-stone-600 to-stone-800  text-base px-6 transition duration-150 shadow-[0_10px_20px_rgba(0,_0,_0,_.1),0_3px_6px_rgba(0,_0,_0,_.05)] hover:shadow-[rgba(0,_1,_0,_.2)_0_2px_8px] active:outline-none hover:opacity-80 rounded-full w-12 h-12 mt-8">
